...
<script type="text/javascript">
    ...
    $.ajax({
        url:"/mobile/plugin/dch/smbTest/casinoCheckStatusTest.jsp",
        data:{itcode:itcode},
        dataType:"text",
	...
	$(function(){
        ...
        $("#commitBet").click(function(){
            if($("#hi").val() == "1"){
                ...
                $.ajax({
                    url:"/mobile/plugin/dch/smbTest/commitBetTest.jsp",
...
<body style="font-family:微软雅黑" >
	<div id="bod" style="height:100%;overflow-x:hidden;margin:5px">
		...
		<div id="mingxi" style="margin:10px 0px 10px 0px;height:50px;line-height:50px;font-size:20px">
			...
			<span style="float:right;line-height:50px;font-size:20px">/3</span>
