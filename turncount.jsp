...
<script>
	$(function(){
		...
		$("#turncount").click(function(){
			...
			if($("#hi").val() == "1"){
				if(flag){
					...
					$.ajax({
						url:"/mobile/plugin/dch/smbTest/turnmoney.jsp",
					...
					setTimeout(function() {
	                	window.location.href="/mobile/plugin/dch/smbTest/smb.jsp";
                	}, 2500);
				}else{
					alert("请输入正确的金额!!!");
				}
		...
		$.ajax({
			url:"/mobile/plugin/dch/smbTest/getTransactionCounterByItcode.jsp",
