        ...
        <script type="text/javascript">
        	...
        	$(function() {
                ...
                $("#apply").click(function() {
                    window.location.href="/mobile/plugin/dch/smbTest/admin/addVoteTopic.jsp?itcode="+itcode;
                });
                ...
                $("#yanzhi").click(function() {
                    window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/yanzhi.jsp?itcode="+itcode;
                });
                $("#yanzhi-man").click(function() {
                    window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/yanzhi-man.jsp?itcode="+itcode;
                });
                $("#article").click(function() {
                    window.location.href="/mobile/plugin/dch/smbTest/PaidArticle/paidArticleMain.jsp?itcode="+itcode;
                });
            });
        </script>
    </head>
    	 ...
    	 <div class="container" style="">
            <div class="row">
                <div class="col-xs-12 col-md-12" align="center" style="margin-top: 5%;">
                    <button id="article" type="button" class="btn btn-default btn-lg btn-block" style="vertical-align: middle;"><img src="./img/newLesson.png" style="width: 25px;height: 25px;float: left;">付费阅读文章</button>
