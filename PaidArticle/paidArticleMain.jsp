        ...
        <script type="text/javascript">
        	...
        	$(function(){
        		$("#newArticle").click(function(){
        			window.location.href="/mobile/plugin/dch/smbTest/PaidArticle/newArticle.jsp?itcode="+itcode;
        		});
                $("#queryArticle").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/PaidArticle/queryArticle.jsp?itcode="+itcode;
                });
                $("#queryMyArticle").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/PaidArticle/myArticles.jsp?itcode="+itcode;
                });
        	})
        </script>
    </head>
