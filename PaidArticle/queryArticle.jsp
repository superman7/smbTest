        ...
        <script type="text/javascript">
            ...
            $(function () {
                ...
                window.turnPage = function(id) {
                    ...
                    $.ajax({
                        url:"/mobile/plugin/dch/smbTest/PaidArticle/getArticleContent.jsp",
                        data:{"id":id},
                        dataType:"json",
                ...
                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smbTest/PaidArticle/getQueryArticle.jsp",
                    dataType: "json",
                    async: false,
                    success: function(data) {
                ...
                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smbTest/PaidArticle/getQueryArticleByHot.jsp",
                    dataType: "json",
                    async: false,
                    success: function(data) {
                        $(data).each(function(index, value) {
