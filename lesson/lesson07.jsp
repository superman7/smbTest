        ...
        <script type="text/javascript">
        	...
        	$(function() {
                var requestArr = function() {
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smbTest/lesson/getLessonInsertItcode.jsp",
                ...
                $("ul a").click(function() {
                    ...
                    if (flag == true) {
                        $(this).attr("href", "./lesson07/" + chapterId + ".html?itcode="+ itcode + "&lessonid=" + lessonid);
                    } else {
                        $("#waitGif").show();
                        ...
                        $.ajax({
                            type: "GET",
                            url: "/mobile/plugin/dch/smbTest/lesson/getInsertBuyInfo.jsp",
                            ...
                            success: function(data) {
                                ...
                                $("#waitGif").hide();
                                window.location.href="./lesson07/" + chapterId + ".html?itcode="+ itcode + "&lessonid=" + lessonid;
                            }
                        });
                    }
                });
    	 ...
    	 <div class="container" style="">
            <div class="row">
                <div class="col-xs-12 col-md-12" align="center" style="margin-top: 5%;">
                    <div>
                        <p style="font-size: 120%;text-align: center;font-weight: bold;">邱岳的产品手记<br><font style="font-size: 80%;color: red;">按章节收费，每章 2 SZB</font></p>
                    </div>
                    <div>
                        <nav class="navbar navbar-default" role="navigation">
                            ...
                            <div class="collapse navbar-collapse" id="navbar-collapse0">
                                <ul class="nav navbar-nav">
                                    <li><a id="00">开篇词 | 产品经理的世界没有对错</a></li>
