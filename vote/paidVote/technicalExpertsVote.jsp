	...
	$(function(){
		...
		$("#turncount").click(function(){
			...
			if(flag){
				...
				$.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smbTest/vote/commitPaidVoteDetail.jsp",
				...
				setTimeout(function() {
                	window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/technicalExperts.jsp?itcode="+fromitcode;
            	}, 2500);
			}else{
				alert("请输入正确的票数!");
			}
