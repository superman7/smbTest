...
<html>
    <head>
        ...
        <script type="text/javascript">
            ...
            $(function () {
                            ...
                            success: function(data) {
                                ...
                                $(infoList).each(function(index, value) {
                                    if (value.loginid === itcode) {
                                        window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/jiupinVote.jsp?count="+$("#main").text()+"&name="+value.lastname+"/"+itcode+"&dept="+value.depName;
                                    }
                                });
                            },
                        });
                ...
                $("#mine").click(function() {
                    window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/viewMine.jsp?itcode="+itcode+"&topicId="+topicId;
                });

                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smbTest/vote/getPaidVoteTop5.jsp",
                    ...
                    success:function(data){
                        ...
                        $(".weui-media-box").click(function(i,n){
                            ...
                            if($name.search(itcode) != -1){
                                ...
                                window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/jiupinVote.jsp?count="+$("#main").text()+"&name="+$name+"&dept="+$dept;
                            }   
                        });
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12" align="center" style="">
                    ...
                    <table class="table table-condensed" style="table-layout: fixed;">
                        <caption id="tabCaption" style="text-align: center;font-size: 22px;font-weight: bold;">酒品排行榜</caption>
                        <col style="width: 30%" />
                        <col style="width: 35%" />
                        <col style="width: 35%" />
                        <thead>
    ...
    <!-- <footer class="navbar-fixed-bottom" style="z-index: 5;">
        <div class="container">
            <div style="width: 100%;height: 60px;border-top: 1px solid gray;">
                <h4 style="margin-left: 15%; color: orange; display: inline-block;">进入查看我的得票</h4>
                <img src="../../img/1.png" style="float:right;width:30px;height:30px;margin-top:10px;" >
            </div>            
        </div>
    </footer> -->
