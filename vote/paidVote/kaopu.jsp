                            ...
                            success: function(data) {
                                ...
                                $(infoList).each(function(index, value) {
                                    if (value.loginid === itcode) {
                                        window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/kaopuVote.jsp?count="+$("#main").text()+"&name="+value.lastname+"/"+itcode+"&dept="+value.depName;
                                    }
                                });
                            },
                        });
                    ...
                    success:function(data){
                        ...
                        $(".weui-media-box").click(function(i,n){
                            ...
                            if($name.search(itcode) != -1){
                                ...
                                window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/kaopuVote.jsp?count="+$("#main").text()+"&name="+$name+"&dept="+$dept;
                            }   
                        });
            ...
            <div class="row">
                <div class="col-xs-12 col-md-12" align="center" style="">
                   ...
                   <table class="table table-condensed" style="table-layout: fixed;">
                        <caption id="tabCaption" style="text-align: center;font-size: 22px;font-weight: bold;">靠谱排行榜</caption>
                        <col style="width: 30%" />
                        <col style="width: 35%" />
                        <col style="width: 35%" />
                        <thead>
