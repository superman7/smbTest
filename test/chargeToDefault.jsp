    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smbTest/test/getChargeDefault.jsp",
                ...
                $("#btnQuery").click(function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smbTest/test/getBalanceQuery.jsp",
                        data: {"jsonStr" : JSON.stringify({
                            "account" : account
                        })},
                        dataType: "json",
                ...
                $("#btnConfirm").click(function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smbTest/test/getChargeConfirm.jsp",
                        data: {"jsonStr" : JSON.stringify({
                            "itcode" : itcode,
                            "account" : account,
                            "password" : password,
                ...
                $("#btnInputConfirm").click(function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smbTest/test/getChargeFromInputAccount.jsp",
                        data: {"jsonStr" : JSON.stringify({
                            "itcode" : itcode,
                            "account" : account,
                            "password" : password,
