        ...
        <script type="text/javascript">
        	...
        	$(function(){
                ...
                $("#enterAMTest").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/test/amBase.jsp?itcode="+itcode;
                });
                $("#jikeTest").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/test/archLessons.jsp";
                });
                $("#rankTest").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/test/rankingList.jsp?itcode="+itcode;
                });
                $("#studyRankTest").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/test/studyRankList.jsp?itcode="+itcode;
                });
                $("#topicShowTest").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/test/topicShow.jsp?itcode="+itcode;
                });
