        ...
        <script type="text/javascript">
            $(function() {
                ...
                window.getKeystore = function(account) {
                    $.ajax({
                        type: "GET", 
                        url: "/mobile/plugin/dch/smbTest/test/getKeystore.jsp",
                ...
                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smbTest/test/getAccManager.jsp",
                    data: {"jsonStr" : JSON.stringify({
                        "itcode" : itcode
                    })},
                    dataType: "json",
                            ...
                            $(data.accountList).each(function(index, value) {
                                if (value.available === 3) {
                                     innerHtml1 = "<div class='panel panel-info' onclick='getKeystore(&apos;" + value.account + "&apos;)'>"
                                        ...
                                        + "<h4>余额 <strong>" + value.balance + "</strong> SZB</h4></div></div>";
