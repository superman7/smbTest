...
<%
	...
	String _itcode = Util.null2String((String) fu.getParameter("itcode"));
	HttpUrlService service = new HttpUrlService();
	String str =  service.doHttpUrlNet("http://10.7.10.87:8082/eth/getBalance?itcode="+_itcode,null , "GET");
	String accountKey = str.substring(0,str.indexOf("_"));
	String balance = str.substring(str.indexOf("_")+1);
 %>
<!DOCTYPE html>
<html>
<head>
	...
	$(function(){
		...
		if(originalBalance == "0"){
   		...
   		$("#dowork").click(function(){
			window.location.href="/mobile/plugin/dch/smbTest/showSignin.jsp?accountKey="+accountKey+"&itcode="+itcode;
   		});
   		// 充值
   		$("#wallet").click(function(){
			// window.location.href="/mobile/plugin/dch/smbTest/showCharge.jsp?accountKey="+accountKey+"&itcode="+itcode;
			window.location.href="/mobile/plugin/dch/smbTest/wallet/amBase.jsp?itcode="+itcode;
   		});
   		// 提现
   		$("#tixian").click(function(){
			window.location.href="/mobile/plugin/dch/smbTest/showCollect.jsp?accountKey="+accountKey+"&itcode="+itcode;
   		});
   		
   		// 消费
   		$("#xiaofei").click(function(){
			window.location.href="/mobile/plugin/dch/smbTest/showItems.jsp?itcode="+itcode;
   		});

   		//使用说明
   		$("#guide").click(function(){
			window.location.href="/mobile/plugin/dch/smbTest/operatingGuide.jsp?itcode="+itcode;
   		});

   		// 测试
   		$("#test").click(function(){
			window.location.href="/mobile/plugin/dch/smbTest/test/showTestItems.jsp?itcode="+itcode;
   		});

   		// 管理员
   		$("#admin").click(function(){
			window.location.href="/mobile/plugin/dch/smbTest/admin/showAdminItems.jsp?itcode="+itcode;
   		});
		...
		$("#zhuanzhang").click(function(){
			$.ajax({
   				url:"/mobile/plugin/dch/smbTest/turnnum.jsp",
				data:{itcode1:itcode},
				dataType:"text",
