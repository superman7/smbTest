    ...
    $(function(){
        ...
        $("#commitBet").click(function(){
            if($("#hi").val() == "1"){
                ...
                $.ajax({
                    url:"/mobile/plugin/dch/smbTest/commitTheWorldCupBet.jsp",
                ...
                setTimeout(function() {
	                window.location.href="/mobile/plugin/dch/smbTest/showGameWorldCupBet.jsp?itcode="+itcode+"&matchid="+matchid;
                }, 2500);
            }else if ($("#hi").val() == "-1") {
                alert("请勿重复提交!");
            }else{
