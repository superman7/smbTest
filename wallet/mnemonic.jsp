...
<html>
    <head>
        ...
        $(function() {
            ...
            $.ajax({
                type: "GET",
                url: "/mobile/plugin/dch/smbTest/wallet/getMnemonic.jsp",
                data: {},
                dataType: "json",
            ...
            $("#btnOk").click(function() {
                ...
                if(confirm("再次提醒您保存好密语与密语密码，丢失后无法恢复") == true){
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smbTest/wallet/getNewAccount.jsp",
                        data: {jsonStr:param},
                        dataType: "json",
                        success: function(data) {
                            if (data.success) {
                                ...
                                window.location.href="/mobile/plugin/dch/smbTest/wallet/newAccount.jsp"
