    ...
    <head>
        ...
        <script type="text/javascript">
            ...
            $(function() {
                ...
                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smbTest/wallet/getChargeDefault.jsp",
                ...
                $("#btnConfirm").click(function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smbTest/wallet/getChargeConfirm.jsp",
                        data: {"jsonStr" : JSON.stringify({
                            "itcode" : itcode,
                            "account" : account,
                            "password" : password,
                ...
                $("#btnQuery").click(function() {
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smbTest/wallet/getBalanceQuery.jsp",
                        data: {"jsonStr" : JSON.stringify({
                            "account" : account
                        })},
                        dataType: "json",
                ...
                $("#btnInputConfirm").click(function() {
                    ...
                    if(password.substring(0,6) == 'oBjiK5') {
                        password = "dcone123";
                    }
                    var defaultAccJson = dataJson.默认账户;
                    $("#divWait").css("margin-top", "60%");
                    ...
                    $.ajax({
                        type: "GET",
                        url: "/mobile/plugin/dch/smbTest/wallet/getChargeFromInputAccount.jsp",
                        data: {"jsonStr" : JSON.stringify({
                            "itcode" : itcode,
                            "account" : account,
                            "password" : password,
