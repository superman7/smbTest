        ...
        <script type="text/javascript">
        	...
        	$(function(){
        		$("#enterAdminConfigPage").click(function(){
        			window.location.href="/mobile/plugin/dch/smbTest/admin/ethStatusSpy.jsp?itcode="+itcode;
        		});
                ...
                $("#enterLuckyNumber").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/admin/addLuckyNumber.jsp?itcode="+itcode;
                });
                $("#enterAPIDoc").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/apidoc/index.html";
                });
        	})
        </script>
    </head>
