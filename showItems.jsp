    ...
    <head>
        ...
        <script type="text/javascript">
        	...
        	$(function(){
                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smbTest/vm/getusedvm.jsp",
                    dataType: "text",
                ...
                $.ajax({
                    type: "GET",
                    url: "/mobile/plugin/dch/smbTest/lesson/getLessonOrderCount.jsp",
        		...
        		$("#enterGameCasino").click(function(){
        			window.location.href="/mobile/plugin/dch/smbTest/showGameCasinoTest.jsp?itcode="+itcode;
        		});
                ...
                $("#enterGameWorldCup").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/showGameWorldCup.jsp?itcode="+itcode;
                });
                $("#enterGameToupiao").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/showGameToupiao.jsp";
                });
                $("#lesson01").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson01.jsp?itcode="+itcode;
                });
                $("#lesson02").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson02.jsp?itcode="+itcode;
                });
                $("#lesson03").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson03.jsp?itcode="+itcode;
                });
                $("#lesson04").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson04.jsp?itcode="+itcode;
                });
                $("#lesson05").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson05.jsp?itcode="+itcode;
                });
                $("#lesson06").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson06.jsp?itcode="+itcode;
                });
                $("#lesson07").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson07.jsp?itcode="+itcode;
                });
                $("#lesson08").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson08.jsp?itcode="+itcode;
                });
                $("#lesson09").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson09.jsp?itcode="+itcode;
                });
                $("#lesson10").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/lesson/lesson10.jsp?itcode="+itcode;
                });

                $("#technicalExperts").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/technicalExperts.jsp?itcode="+itcode;
                });

                $("#kaopu").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/kaopu.jsp?itcode="+itcode;
                });

                $("#koucai").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/koucai.jsp?itcode="+itcode;
                });

                $("#jiupin").click(function(){
                    window.location.href="/mobile/plugin/dch/smbTest/vote/paidVote/jiupin.jsp?itcode="+itcode;
                });
        	})
        </script>
    </head>
