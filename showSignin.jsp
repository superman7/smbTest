...
<script type="text/javascript">
	...
	$.ajax({
		url:"/mobile/plugin/dch/smbTest/getSigninStatus.jsp",
		data:{itcode:itcode},
		dataType:"json",
	...
	$(function(){
		$.ajax({
			url:"/mobile/plugin/dch/smbTest/vote/getVoteTodayTopic.jsp",
			dataType:"json",
			async:false, 
			success:function(data){
		...
		$("#qian").click(function(){
			...
			$("#qian2").show();
			$.ajax({
				url:"/mobile/plugin/dch/smbTest/getSigninInfo.jsp",
				data:{itcode:itcode},
				dataType:"json",
				success:function(data){
					console.log(data);
					if(data.status == 1){
						$.ajax({
							url:"/mobile/plugin/dch/smbTest/getRewards.jsp",
		...
		$(".option").click(function(){
			...
			$.ajax({
				url:"/mobile/plugin/dch/smbTest/vote/getTodayVoteStatus.jsp",
				...
				success:function(data){
					if (data.trim() == 'true') {
						...
						if (confirm(confirmMsg)==true){
							$.ajax({
								url:"/mobile/plugin/dch/smbTest/vote/commmitVoteInfo.jsp",
								...
								success:function(data){
									alert("投票成功！");
									$.ajax({
										url:"/mobile/plugin/dch/smbTest/getVoteRewards.jsp",
										data:{itcode:itcode},
										dataType:"text",
										success:function(data){
										}
		...
		$.ajax({
			url:"/mobile/plugin/dch/smbTest/vote/getVotePopularity.jsp",
			data:{topicID:topicID},
			dataType:"json",
			success:function(data){
		...
		$.ajax({
			url:"/mobile/plugin/dch/smbTest/vote/getOptionPopularity.jsp",
			data:{topicID:topicID},
			dataType:"json",
			success:function(data){
				$(data).each(function(){
